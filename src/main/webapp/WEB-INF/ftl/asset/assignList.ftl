                        ...
                        <div class="x_content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="unit" name="unit" required="required"
                                               class="form-control col-md-7 col-xs-12" value="${assets.unit}" readonly/>
                                    </div>
                                </div>
                            ...
                            <#--信息录入-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control col-md-7 col-xs-12" name="departId">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                        <button type="button" id="sub" class="btn btn-success">确认分配</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script>
    jQuery(document).ready(
            ...
            $("#sub").click(function () {
                ...
                var load = layer.load();
                $.post("/asset/assignAssetToDepart", $("#assetsform").serialize(), function (result) {
                    layer.close(load);
