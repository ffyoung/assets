         ...
         <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
             ...
             <div class="menu_section">
                 ...
                 <ul class="nav side-menu">
                     ...
                     <li><a><i class="fa fa-windows"></i> Test <span class="fa fa-chevron-down"></span></a>
                         <ul class="nav child_menu">
                             <li><a href="/test/down">TestDown
                                   <span class="label label-success pull-right">Testing</span>
                                 </a>
                             </li>
