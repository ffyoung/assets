            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br/>
                            <form id="departform" data-parsley-validate class="form-horizontal form-label-left">
                                <input name="id" value="${department.id}" hidden/>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">部门名称 <span
                                            class="required">*</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">部门编号<span
                                            class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="number" name="number" value="${department.number}"
                                               required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
...
<script>
    jQuery(document).ready(
            $("#sub").click(function () {
                ...
                var load = layer.load();
                $.post("/depart/updateDepart", $("#departform").serialize(), function (result) {
                    layer.close(load);
                    if (result && result.status != 200) {
                        ...
                        layer.msg('修改成功!');
                        setTimeout(function () {
                            window.location.href = "/depart/all?pageNow=" + 1;
                        }, 2000);
                    }
                }, "json");
            })
