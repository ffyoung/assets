            ...
            <div class="page-title">
                <div class="title_left">
                    ...
                    <div style="position: absolute;right: 1cm;">
                        <a href="/depart/addDepartIndex" class="btn btn-default">新增部门</a>
                    </div>
                    <hr/>
                    <form id="formId" method="post" action="/depart/all" autocomplete="off">
                        <div class="col-md-5 col-sm-5 col-xs-12 form-group  top_search">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="输入部门名称/编号" name="content"
...
<script>
    ...
    function pageDo(page) {
        var wd = $("#content").val();
        var url = "/depart/all?pageNow=" + page + "&content=" + wd;
        window.location.href = url;
    }

    /*更改信息页面跳转*/
    function updateMsg(id) {
        var url = "/depart/updateDo/" + id;
        window.location.href = url;
    }
